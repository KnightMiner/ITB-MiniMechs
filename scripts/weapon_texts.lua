return {
  ...
  Mini_Mirrorshot_Upgrade1 = "+1 Damage",
  Mini_Mirrorshot_A_UpgradeDescription = "Increases damage by 1.",
  ...
  Mini_DeployMirrorTank_Upgrade2 = "+1 Damage",
  Mini_DeployMirrorTank_A_UpgradeDescription = "Increases the tank's max health to 3.",
  Mini_DeployMirrorTank_B_UpgradeDescription = "Increases the tank's attack damage to 2.",
